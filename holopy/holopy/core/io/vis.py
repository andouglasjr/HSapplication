...
class Show2D(object):
    def __init__(self, im, i=0):
        ...
        self._title()
        self.plot = self.ax.imshow(self.im[self.i], vmin=vmin, vmax=vmax,
    ...
    def get_fig(self):
        #points = self.ax.scatter(np.random.rand(50), np.random.rand(50),
         #           s=500, alpha=0.3)
        #plugins.connect(self.fig, ChangePlanDistance(points))
        return self.fig
...
class ChangePlanDistance(plugins.PluginBase):
    """ Pluging for change sensor's plan distance from holography plan."""

    JAVASCRIPT = """
    mpld3.register_plugin("changeplandistance", ChangePlanDistance);
    ChangePlanDistance.prototype = Object.create(mpld3.Plugin.prototype);
    ChangePlanDistance.prototype.constructor = ChangePlanDistance;
    ChangePlanDistance.prototype.requiredProps = ["id"];
    function ChangePlanDistance(fig, props){
        mpld3.Plugin.call(this, fig, props);
    };

    ChangePlanDistance.prototype.draw = function(){
    ...
    def __init__(self, points):
        self.dict_ = {"type": "changeplandistance",
